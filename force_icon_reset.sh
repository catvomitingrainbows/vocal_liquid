...
echo "=== Force Icon Reset Patch for VocalLiquid ==="
echo "This is a direct, aggressive fix for the orange icon issue."

# Check if the app is running and kill it
pkill -f VocalLiquid || true

# Create the Utilities directory if it doesn't exist
mkdir -p /Users/almonds/repo/claude/vocal_liquid/VocalLiquid/Utilities

# Create a file with an extension to force icon state reset
cat > /Users/almonds/repo/claude/vocal_liquid/VocalLiquid/Utilities/IconReset.swift << 'EOF'
import Cocoa
...
# Create a modified StatusBarController with improved icon resetting
cat > /Users/almonds/repo/claude/vocal_liquid/VocalLiquid/Managers/StatusBarController.swift.new << 'EOF'
import Cocoa
import SwiftUI
...
cp /Users/almonds/repo/claude/vocal_liquid/VocalLiquid/Managers/StatusBarController.swift /Users/almonds/repo/claude/vocal_liquid/VocalLiquid/Managers/StatusBarController.swift.bak

# Replace with the new file
mv /Users/almonds/repo/claude/vocal_liquid/VocalLiquid/Managers/StatusBarController.swift.new /Users/almonds/repo/claude/vocal_liquid/VocalLiquid/Managers/StatusBarController.swift

echo 
echo "=== Icon Reset Fixed ==="
echo "The StatusBarController has been updated with a more robust icon reset implementation."
echo "A new IconReset.swift file has been added that will force the icon to reset if the standard methods fail."
echo
echo "To build and run the app with these changes:"
echo "  ./build_background.sh"
echo
echo "For testing a simpler menu bar app that isolates just the icon functionality:"
echo "  ./test_menubar.sh"
echo
echo "If you still experience issues, please let me know and we can try additional fixes."